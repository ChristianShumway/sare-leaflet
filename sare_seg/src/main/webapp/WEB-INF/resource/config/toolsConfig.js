define(function () {
    return{
        timeLine: {
            base: {
                url: 'https://gaia.inegi.org.mx/NLB/tunnel/wms/mdm6wms?map=/opt/map/mercator.map',
                layer: 'c104'
            },
            layers: 'https://gaia.inegi.org.mx/NLB/tunnel/wms/mdm6wms?map=/opt/map/mdm60/mdm6vectorsolar.map'
        },
        routing: {
            dataSource: {
                fuels: {
                ...
                route: {
                    ...
                    url: 'https://10.1.30.102:8181/routing/',
                    type: 'POST',
                    dataType: "json",
                    stringify: true,
                    params: {}
                ...
                autocomplete: {
                    url: 'https://10.1.30.101:9090/solr/busq-ruteodestinos/shard',
                    params: {
                        q: '',
                        wt: 'json',
                        indent: true,
                ...
                saveStats: {
                    url: 'https://gaia.inegi.org.mx/NLB/tunnel/mapGeoelectoral/stats/layers',
                    type: 'POST',
        ...
        denue: {
            ...
            urlDownloadService: 'https://mapserver.inegi.org.mx/denue_mdm/procesaDescarga.do',
            tools: {
            ...
            dataSources: {
                view: {
                    url: 'https://gaiamapas.inegi.org.mx/mdmSearchEngine/denue_2014/select',
                    type: 'POST',
                    dataType: "jsonp",
                    jsonp: 'json.wrf',
                    stringify: false,
                ...
                searchLayer: {
                    url: 'https://gaiamapas.inegi.org.mx/mdmSearchEngine/busq-denue_sector/select',
                    type: 'POST',
                    dataType: "jsonp",
                    jsonp: 'json.wrf',
                    stringify: false,
                ...
                download: {
                    url: 'https://gaia.inegi.org.mx/NLB/tunnel/mapGeoelectoral/denue/list',
                    contentType: "application/json; charset=utf-8",
                    type: 'POST',
                    dataType: "json"
                }
