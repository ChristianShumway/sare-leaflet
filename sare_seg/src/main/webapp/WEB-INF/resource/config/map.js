var MapConfig = {
        layers:[
            
            {
                    type:'Wms',
                    label:'Vectorial',		             
                    url:'http://10.1.33.123/fcgi-bin/ms62/mapserv.exe?map=/opt/map/mdm60/mdm6Ecoseg.map&',
                    tiled:false,
                    format:'png'
            },
            {
                    type:'Wms',
                    label:'Text',		             
                    url:'http://10.1.30.102/fcgi-bin/mapserv.exe?map=/opt/map/mdm6texto.map&',
                    tiled:false,
                    format:'png'
            },
			{
        ...
        resolutions:[4891.969809375,2445.9849046875,1222.99245234375,611.496226171875,305.7481130859375,152.87405654296876,76.43702827148438,38.21851413574219,19.109257067871095,9.554628533935547,4.777314266967774,2.388657133483887,1.1943285667419434,0.5971642833709717,0.29858214168548586,0.14929107084274293,0.07464553542137146,0.0373227677106857,0.0186613838553429],
        buffers:{
                limit:'1000'
        },
        timeLine:{
