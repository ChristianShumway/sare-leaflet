            ...
            if (pendientes != null && pendientes.size() > 0) {
                for (cat_vw_punteo_sare obj : pendientes) {
                    if (proyecto.equals(3)) {
                        if (GuardarRegistroUEEPAsincronizar(obj, proyecto, usuario)) {
                            if (ActualizaBitacora(proyecto, obj, usuario)) {
                                if (ActualizaIdUEPg(proyecto, obj, usuario)) {
                                    if (ConfirmaUEPg(proyecto, obj, usuario)) {
