    ...
    var sourcesConfig = {
        ...
        gpx: {
            save: 'https://10.1.30.102:8181/mdmexport/gpx/download',
            read: 'https://10.1.30.102:8181/mdmexport/gpx/upload'
        ...
        cluster: {
            ...
            recordCard: {
                url: 'https://10.1.30.102:8181/map/denue/label',
                type: 'POST',
                dataType: 'json'
            },
            nodes: {
                //url:'http://10.1.30.102:8181/map_etp2/denue/scian',
                url: 'https://10.1.30.102:8181/map/denue/scian',
                type: 'POST',
                dataType: 'json'
            },
            geometry: {
                url: 'https://10.1.30.102:8181/map/wkt/feature',
                type: 'POST',
                dataType: 'json'
            }
        },
        ...
        georeferenceAddress: {
            url: 'https://10.1.30.102:8181/map/reversegeocoding',
            //url:'json/address.do',
            type: 'POST', //POST
            dataType: "json",
            contentType: "application/json; charset=utf-8"
        ...
        mousePosition: {
            elevation: {
                url: 'https://10.1.30.102:8181/map/raster/elevation',
                type: 'POST',
                dataType: 'json'
            }
        },
